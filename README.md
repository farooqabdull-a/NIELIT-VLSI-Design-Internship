...
| 09 | [`09_Logic_Synthesis`](./Digital%20VLSI%20Design/09_Logic_Synthesis) | ASIC logic synthesis using **Synopsys Design Compiler** for USR, ALU, and `'10110'` sequence detector (timing/area/power mapping). |
